...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    const dropdownIngredients = new Dropdown(
        ingredients,
        document.getElementsByClassName("ingredient")[0],
        "Ingrédient",
        "ingredient",
        changeFilters
    );
    ...
    const dropdownUstensils = new Dropdown(
        ustensiles,
        document.getElementsByClassName("ustensil")[0],
        "Ustensiles",
        "ustensils",
        changeFilters
    );
    ...
    const dropdownAppareils = new Dropdown(
        appareil,
        document.getElementsByClassName("appareil")[0],
        "Appareil",
        "appareil",
        changeFilters
    );
    ...
    search.addEventListener("search", () => {
        ...
        document
            .getElementsByClassName("fa-search")[0]
            .classList.remove("icon-search-hide");
    });
